...
As to why the test restricts agential communication to typewritten messages; Turing reasons that, as the deafblind #link("https://en.wikipedia.org/wiki/Helen_Keller")[Helen Keller] is nevertheless clearly intelligent, the domain of intelligence should not require anything particularly corporeal other than (typewritten) language.#footnote[#quote[We need not be too concerned about the legs, eyes, etc. The example of Miss Helen Keller shows that education can take place provided that communication in both directions between teacher and pupil can take place by some other means. @turingComputingMachineryIntelligence2004[p.471]]].
