...
// Prompt engineering is the practice of carefully crafting the text you provide to an #link(<llm>)[LLM] to get better, more accurate, or more useful responses: essentially learning to 'speak' to AI systems in ways that leverage how they actually work.
// This can involve techniques like providing examples in your #link(<prompt>)[prompt] (called #link(<few-shot>)[few-shot] prompting), breaking complex tasks into step-by-step instructions, specifying the format you want the output in, or even assigning the model a role like #quote[you are an expert Python developer].
