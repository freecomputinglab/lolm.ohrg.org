...
// The #link(<chat-assistant>)[chat assistants] you use, like ChatGPT or Claude, started as #link(<base-model>)[base models], but then underwent additional training phases to transform them from text-completion engines into helpful conversational assistants that understand instructions and maintain appropriate boundaries.
